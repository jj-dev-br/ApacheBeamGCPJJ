...
pipeline_options = {
  ...
  "template_location":"gs://beam-tooltorial/template/batch_job_df_gcs_voos",
...
tabela = 'beam-tooltorial:beam_tooltorial_voos.beam_tooltorial_voos_atraso'

Tempo_Atrasos = (
  p1
  | "Importar Dados Atraso" >> beam.io.ReadFromText(r"gs://beam-tooltorial/entrada/voos_sample.csv", skip_header_lines = 1)
...
Qtd_Atrasos = (
  p1
  | "Importar Dados" >> beam.io.ReadFromText(r"gs://beam-tooltorial/entrada/voos_sample.csv", skip_header_lines = 1)
...
tabela_atrasos = (
    ...
    | beam.io.WriteToBigQuery(
                              ...
                              custom_gcs_temp_location = 'gs://beam-tooltorial/temp' )
